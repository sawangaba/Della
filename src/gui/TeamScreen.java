 ...
 * </p>
 *
 * @author Lynn Robert Carter, Modified by Sawan Gaba 2020-01-25
...
public class TeamScreen {
	...
	private Label Affiliation = new Label("To add a member association for a team:");
	private Label Affiliation1 = new Label("1.Click on the name of the team above right.");
	private Label Affiliation2 = new Label("2.Click on a member name in the list below.");
	private Label Affiliation3 = new Label("3.Click on \u201C Add association \u201C button. ");
	private Label Affiliation4 = new Label("Available members for team");
	private Label Affiliation44 = new Label("Current  members for team");
	private Label Affiliation6 = new Label("Click on an team name " + "\n" + "to see member association ");
	private Label removeAffiliation = new Label("To remove a member association for a team:");
	private Label removeAffiliation1 = new Label("1. Click on the name of the team above.");
	private Label removeAffiliation2 = new Label("2. Click on a member name in the list below.");
	private Label removeAffiliation3 = new Label("3. Click on \"Remove association\" button.");
	...
	public TeamScreen(Group teamGroup) {
		...
		teamGroup.getChildren().addAll(Name, text1, AddName, Click, Type, Addlist, RemoveName, ClickName, Removelist,
				Add, Remove, Memberlist, LxtName,Affiliation4,Affiliation44,Affiliation6,removeAffiliation, removeAffiliation1, removeAffiliation2, removeAffiliation3, Affiliation, Affiliation1, Affiliation2, Affiliation3,Affiliation5, Affiliation55, teamlist, currentteam, Addaf, Removeaf);
...
// Define the text fields
	...
	private void selectActionItem(ObservableValue<? extends String> observableValue, String oldValue, String newValue) {
		Affiliation5.setText(Memberlist.getSelectionModel().getSelectedItem().toString());
		Affiliation55.setText(Memberlist.getSelectionModel().getSelectedItem().toString());
